...
def load_config() -> SatelliteConfig:
    ...
    Fails fast if LITELLM_API_KEY or OPENCLAW_GATEWAY_TOKEN is missing.
    ...
    return SatelliteConfig(
        ...
        litellm_url=os.getenv("LITELLM_URL", "https://llm.frizzt.com/v1"),
        llm_model=os.getenv("LLM_MODEL", "qwen-moe-coder-fast"),
        llm_history_messages=int(os.getenv("LLM_HISTORY_MESSAGES", "20")),
