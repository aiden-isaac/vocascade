...
- [x] T048 Update unit tests (`test_config.py`, `test_session.py`, `test_server.py`, `test_openclaw_client.py`) to cover the new `gateway_agent_id` field, `sessions_abort`, and barge-in context logic; delete `test_router.py` and `test_task_tracker.py`
